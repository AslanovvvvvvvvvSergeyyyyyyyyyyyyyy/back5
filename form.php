        ...
        <div>
                ...
                <label>
                  ...
                  <select name="ability[]"
                    ...
                    <option value="0" <?php echo (in_array("0",$ability)) ?  "selected" : ""  ; ?>>Run</option>
                    <option value="1" <?php echo (in_array('1',$ability)) ?  "selected" : ""  ; ?>>Lie</option>
                    <option value="2" <?php echo (in_array('2',$ability)) ?  "selected" : ""  ; ?>>Sit</option>
                  </select>
                </label><br />
